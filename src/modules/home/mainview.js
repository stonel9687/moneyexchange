  ...
  const dataRequest = () => {
    fetch('http://api.currencylayer.com/live?access_key=8468d131ff9fc41223ad0a8a2beb3d26', {
      ...
      .then((data) => {
        ...
        setDataArgentina(data.quotes.USDARS.toFixed(0))
        setDataChile(data.quotes.USDCLP.toFixed(0))
        setDataColombia(data.quotes.USDCOP.toFixed(0))
        setDataParaguay(data.quotes.USDPYG.toFixed(0))
        setDataMexico(data.quotes.USDMXN.toFixed(0))
